...
def creer_trajet(request):
    ...
    return render(request, 'trajets_templates/creer_trajet.html', {'form': form})
...
def liste_trajets(request):
    ...
    return render(request, 'trajets_templates/liste_trajets.html', {
        'trajets': trajets,
        'today': today,
...
def modifier_trajet(request, trajet_id):
    ...
    return render(request, 'trajets_templates/modifier_trajet.html', {'form': form, 'trajet': trajet})
...
def trajets_disponibles(request):
    ...
    return render(request, 'trajets_templates/trajets_disponibles.html', {
        'trajets': trajets,
        'point_depart': point_depart,
        'point_arrivee': point_arrivee,
        'date_depart': date_depart
...
def afficher_carte(request, id):  # L'argument doit être 'id'
    ...
    return render(request, 'trajets_templates/afficher_carte.html', {'start_point': start_point, 'end_point': end_point})
...
def statistiques_view(request):
    ...
    return render(request, 'trajets_templates/statistiques.html', {'stats': stats})
