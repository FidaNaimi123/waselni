...
class Carpool(models.Model):
    ...
    members = models.ManyToManyField(User, related_name='carpool_groups')
    creator = models.ForeignKey(User, on_delete=models.CASCADE, related_name='created_carpools', null=True)
